    ...
    private sealed class ExchangeRateTestDatabase : IAsyncDisposable
    {
            ...
            bool addDuplicateRaceTrigger = false)
        {
            ...
            await context.Database.ExecuteSqlRawAsync(
                ...
                CREATE TABLE CashVouchers (Id INTEGER PRIMARY KEY, CompanyId INTEGER NOT NULL, EmployeeId INTEGER NULL, AccountId INTEGER NULL, ExchangeRateId INTEGER NULL, CashboxTransferId INTEGER NULL, IsDeleted INTEGER NOT NULL);
