...
public sealed class DashboardSwaggerDocumentation : IOperationFilter
{
        ...
        OperationFilterContext context)
    {
        ...
        operation.Description = SwaggerOperationDescription.Create(
            ...
            "المبيعات والمشتريات والمبالغ المستحقة والربحية بالعملة الأساسية. أرصدة الخزائن منفصلة حسب العملة ولا تُجمع عملات مختلفة. قيمة المخزون والأصناف ذات الرصيد لقطة حالية وليست لقطة تاريخية. `businessPartnerCount` هو إجمالي سجل العملاء والموردين الموحد في الشركة، بما فيه النشط وغير النشط، مع استبعاد المحذوف فقط.",
