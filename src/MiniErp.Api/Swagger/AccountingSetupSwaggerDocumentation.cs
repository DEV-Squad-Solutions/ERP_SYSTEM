        ...
        methodName switch
        {
            ...
            nameof(AccountsController.GetJournalSelect) => (
                ...
                SwaggerOperationDescription.Create(
                    ...
                    "السنة يجب أن تكون موجودة في الشركة الحالية. يعيد كل حساب فرعي فعال وقابل للتسجيل داخل الشركة، بما في ذلك الحسابات المرتبطة بعناصر تشغيلية.",
                    "عند استخدام حساب مرتبط تشغيليًا في قيد يدوي، تجنب تسجيل نفس الأثر مرتين؛ القيود التلقائية تنشأ من الحركة المصدر.")),
