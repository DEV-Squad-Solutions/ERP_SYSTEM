        ...
        OperationFilterContext context)
    {
        ...
        var documentation = context.MethodInfo.Name switch
        {
            ...
            nameof(CompaniesController.Create) => (
                "Create a company",
                SwaggerOperationDescription.Create(
                    "Admin only. Atomically creates a company, grants the authenticated admin access, and provisions the current fiscal year, the default numeric chart of accounts, operational account mappings, and the three financial-statement designs.",
