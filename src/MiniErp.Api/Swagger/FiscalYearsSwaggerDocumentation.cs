        ...
        OperationFilterContext context)
    {
        ...
        var documentation = context.MethodInfo.Name switch
        {
            ...
            nameof(FiscalYearsController.Reopen) => (
                ...
                SwaggerOperationDescription.Create(
                    "للمسؤول فقط. يعيد فتح سنة مالية مغلقة مؤقتًا للسماح بتعديل الحركات التابعة لتاريخها. لا يحذف قيد FiscalYearClosing المرحّل إلى السنة التالية.",
                    "معرّف السنة المغلقة في المسار `id`.",
                    "يجب أن يكون `id` أكبر من صفر وأن تكون السنة مغلقة.",
                    "إعادة الفتح لا تجعل السنة هي الحالية؛ تظل السنة الحالية كما هي. بعد انتهاء التعديل يمكن إغلاق السنة مرة أخرى، ويمنع فحص idempotency والفهرس الفريد تكرار قيد الافتتاح. السنة المفتوحة بالفعل ترجع 409 بالرمز `FiscalYears.AlreadyOpen`.")),
