        ...
        OperationFilterContext context)
    {
        ...
        var documentation = context.MethodInfo.Name switch
        {
            ...
            nameof(JournalEntriesController.GetById) => (
                "تفاصيل قيد يومية",
                "يعرض رأس القيد وكل أسطر المدين والدائن ومصدر القيد إن كان تلقائيًا، ومع كل سطر بيانات الطرف التحليلية إن وجدت."),
            nameof(JournalEntriesController.Create) => (
                "إضافة وترحيل قيد فورًا",
                "يحفظ القيد كقيد مرحل مباشرة بدون مسودة أو خطوة ترحيل مستقلة. يجب أن يتساوى إجمالي المدين والدائن، وأن تكون السنة مفتوحة والحسابات تفصيلية وفعالة. حسابات العملاء والموردين والموظفين والسائقين والخزائن تتطلب `partyType` و`partyId` مطابقين في كل سطر، وحساب الخزينة يقبل فقط الخزائن المربوطة به في السنة المالية. لا تقبل الحسابات العادية بيانات طرف."),
