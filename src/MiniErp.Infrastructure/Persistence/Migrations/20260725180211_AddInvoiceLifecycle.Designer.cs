...
namespace MiniErp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260725180211_AddInvoiceLifecycle")]
            ...
            modelBuilder.Entity("MiniErp.Domain.Entities.Invoicing.Invoice", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "OriginalInvoiceId");
            ...
            modelBuilder.Entity("MiniErp.Domain.Entities.Invoicing.InvoiceLine", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "OriginalInvoiceLineId");
            ...
            modelBuilder.Entity("MiniErp.Domain.Entities.Invoicing.Invoice", b =>
                {
                    ...
                    b.HasOne("MiniErp.Domain.Entities.Invoicing.Invoice", "OriginalInvoice")
                        .WithMany()
                        .HasForeignKey("CompanyId", "OriginalInvoiceId")
                        .HasPrincipalKey("CompanyId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("MiniErp.Domain.Entities.Invoicing.InvoiceLine", b =>
                {
                    ...
                    b.HasOne("MiniErp.Domain.Entities.Invoicing.InvoiceLine", "OriginalInvoiceLine")
                        .WithMany()
                        .HasForeignKey("CompanyId", "OriginalInvoiceLineId")
                        .HasPrincipalKey("CompanyId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);
